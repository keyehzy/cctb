...
void AsymptotePainter::SetAxis(float xmin, float xmax, float ymin, float ymax) const {
...
void AsymptotePainter::DrawDottedLine(float x1, float y1, float x2, float y2) const {
...
void AsymptotePainter::DrawText(float x, float y, const std::string& text) const {
